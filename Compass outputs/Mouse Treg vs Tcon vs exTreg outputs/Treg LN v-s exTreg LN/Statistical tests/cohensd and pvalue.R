...
# Load data
df <- read.csv("TregLN vs exTregLN pvalue adn cohensd statistical test.csv", check.names = FALSE)
...
# Save
write.csv(results, "Statistical test pvalue and cohensd output.csv", row.names = FALSE)
