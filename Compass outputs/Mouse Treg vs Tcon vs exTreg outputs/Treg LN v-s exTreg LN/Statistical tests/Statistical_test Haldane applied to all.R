...
# Read file
file1 <- read.csv("TregLN vs exTregLN pvalue adn cohensd statistical test.csv")
...
# Save to CSV
write.csv(results, "TregSP vs exTregSP pvalue adn cohensd statistical test.csv", row.names = FALSE)
